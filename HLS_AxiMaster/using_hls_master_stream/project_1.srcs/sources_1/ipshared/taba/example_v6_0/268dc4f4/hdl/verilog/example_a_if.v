...
//------------------------Instantiation------------------
// example_a_request_preprocessor
example_a_request_preprocessor #(
...
module example_a_request_preprocessor/*{{{*/
#(parameter
    C_USER_DATA_WIDTH = 8
)(
    // system signal
...
module example_a_read_data_align/*{{{*/
#(parameter
    C_DATA_WIDTH      = 32,
    C_USER_DATA_WIDTH = 8
)(
