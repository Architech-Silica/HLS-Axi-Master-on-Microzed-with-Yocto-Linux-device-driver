...
set IPName      "example"
set Version     "6.0"
set DisplayName "stream2aximaster"
set Revision    "1505251521"
...
set Interfaces {
    ...
    S_AXI_MYAXIL {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_MYAXIL"
        param_prefix "C_S_AXI_MYAXIL"
        addr_bits "6"
    }
    ap_ctrl {
        type "ap_ctrl"
        ctrl_ports "ap_start ap_ready ap_done ap_idle"
    }
    aclk {
        type "clock"
        buses "M_AXI_A S_AXI_MYAXIL stream_in"
    }
    aresetn {
        type "reset"
    }
